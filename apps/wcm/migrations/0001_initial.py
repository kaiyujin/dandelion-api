# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-27 20:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=20)),
                ('sort_no', models.IntegerField()),
                ('status_type', models.CharField(choices=[('first', '作成中'), ('second', '上長コメント中'), ('exe', '実践中'), ('eval', '振り返り'), ('end', '終了')], max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='Will',
        ...
        migrations.AddField(
            model_name='sheet',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wcm.Status'),
        ),
        migrations.AddField(
            model_name='sheet',
            name='user',
